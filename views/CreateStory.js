...
function CreateStory({navigation}) {
  ...
  let SaveButton = () => {
   return (
     <HighlightButton title="Save"
       ...
       style={{width: "50%", padding: 0, borderTopWidth: 1, borderLeftWidth: 1, borderColor: '#616161' }}
     />
    );
  };
  ...
  let CancelButton = () => {
   return (
     <HighlightButton title="Cancel"
       onPress={() => setShowModal(false)}
       style={{width: "50%", borderTopWidth: 1, borderColor: '#616161', padding: 0}}
     />
    );
  };
