...
export let FavoriteButton = (props) => {
  ...
  return (
    <View>
     ...
     >
      <MaterialCommunityIcons name="star" color={fav ? 'yellow' : '#616161'} size={50} />
      </Pressable>
    </View>
...
export let DeleteButton = (props) => {
  ...
  return (
    <View >
     <Pressable
      style={[props.style, { backgroundColor: backColor}]}
      onPressIn={() => {setColor("#424242"), setBinColor("#FFF")}}
      onPressOut={() => {setColor(null), setBinColor("#616161")}}
      onPress={() => alert(`Delete ${props.item.name}?`)}
     >
